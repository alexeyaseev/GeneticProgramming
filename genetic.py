...
def get_best(get_fitness, targetLen, optimalFitness, geneSet, display, custom_mutate=None, custom_create=None, maxAge=None, poolSize=1, crossover=None):
...
def _get_improvement(new_child, generate_parent, maxAge, poolSize):
    ...
    while True:
        ...
        if parent.Fitness > child.Fitness:
            ...
            # proportionSimilar = difference/len(historicalFitnesses) #book version: bug?
